...
namespace Model.Types.Attribute
{
	//ToDo: refactor
	...
	public class CommandSystenAttribute : MessageAttribute, ICheckAttribute, ITypeUserAttribute
	{
		...
		public CommandSystenAttribute(string boolPropertyName, MessageType typeMessages, SystemType sType, TypeUser typeUser = TypeUser.Admin)
			: base(boolPropertyName, typeMessages, typeUser)
		{
			SType = sType;
		}
