namespace Model.Logic.Settings
{
	public static class Const
	{
		public static class Braille
		{
			...
			public const string braille8 = "br8";
		}
		...
		public static class Game
		{
			...
			public const string Stop = "stopgame";
			public const string Clear = "cleargame";

			public const string Send = "sendcode";
			public const string LvlText = "lvlinfo";
			public const string LvlAllText = "lvlinfoall";
			...
			public const string LastCodes = "allsectors";
			public const string Codes = "sectors";
		...
		{
			public const string LastLvl = "LastLvl";
		}
	}
}
