...
namespace Nastya
{
	public class ChatMapper  : ISendMessage
	{
		List<object> _classes = new List<object>();

		private readonly ConcurrentStack<CommandMessage> _messages = new ConcurrentStack<CommandMessage>();
		private readonly Dictionary<Guid, (string, IMessage)> _needAnswers = new Dictionary<Guid, (string, IMessage)>();
		private readonly List<MaperMethodOnAllMsg> _methodsAllMsg = new List<MaperMethodOnAllMsg>();
		private readonly Dictionary<string, List<MaperPropInfo>> _properties = new Dictionary<string, List<MaperPropInfo>>();
		private readonly Dictionary<string, List<MaperMethodInfo>> _methods = new Dictionary<string, List<MaperMethodInfo>>();
		...
		public ChatMapper(TypeBot typeBot, Guid chatId)
		{
			ChatId = chatId;
			_typeBot = typeBot;
		...
		public void SendMsg(TransactionCommandMessage tMessage)
		{
